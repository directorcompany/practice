						...
						<ul id="accordion" class="sj-articledetails sj-articledetailsvtwo">
							<li id="headingOne" class="sj-articleheader" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
								<div class="sj-detailstime">
									...
									<h4>4 Ways You Can ____ Your Creativity Using technology </h4>
								</div>
							...
							<li id="collapseOne" class="collapse sj-active sj-userinfohold" aria-labelledby="headingOne" data-parent="#accordion">
								<div class="sj-userinfoimgname">
									<figure class="sj-userinfimg">
										<img src="/public/images/thumbnails/img-02.jpg" alt="img description">
									</figure>
									<div class="sj-userinfoname">
										<span>04 days ago on ______ at 14:49 </span>
										<h3>Aleen Monsour (You) </h3>
									</div>
									<div class="sj-userbtnarea">
										<button type="button" class="sj-btn sj-btnactive" data-toggle="modal" data-target="#reviewermodal">Assign Reviewer <em class="sj-notificationtag">01 </em></button>
										<button type="submit" class="sj-btn" data-toggle="modal" data-target="#feedbackmodal">Send Feedback </button>
									</div>
									<div class="sj-description">
										<p>Consectetur adipisicing elit, sed __ eiusmod tempor incididunt ut ______ etnalo doloreae magna aliqua ____ ad minim veniam quis ______ exercitation ullamco laboris nisi ____ aliquip  amet consectetur ___________ elit sed do eiusmod ______ incididunt ut labore. </p>
									</div>
									<div class="sj-downloadheader">
										...
										<div class="sj-docdetails">
											<figure class="sj-docimg">
												<img src="/public/images/thumbnails/doc-img.jpg" alt="img description">
											</figure>
								...
								<div id="subaccordion" class="sj-statusholder">
									<div id="subheadingOne" class="sj-statusheaderholder sj-statuspadding" data-toggle="collapse" data-target="#subcollapseOne" aria-expanded="true" aria-controls="subcollapseOne" role="button">
										<figure class="sj-statusimg">
											<img src="/public/images/thumbnails/img-03.jpg" alt="img description">
										</figure>
									...
									<div id="subcollapseOne" class="sj-statusdescription collapse sj-active" aria-labelledby="subheadingOne" data-parent="#subaccordion">
										<div class="sj-description">
											<p>Excepteur sint occaecat cupidatat ___ proident, sunt in culpa ___ officia deserunt mollit laudantium, ____  sunt voluptatem quia ________ sit aspernatur aut odit ___ fugit. </p>
										</div>
										<ul class="sj-statusdescriptionpoints">
											<li><span>Nemo enim ipsam voluptatem ____ </span></li>
											<li><span>Adipisci velit, sed quia ___ numquam eius modi tempora </span></li>
											<li><span>Qui dolorem ipsum quia _____ sit amet </span></li>
										</ul>
										<div class="sj-description">
											<p>Excepteur sint occaecat cupidatat ___ proident, sunt in culpa ___ officia deserunt mollit laudantium, ____  sunt voluptatem quia ________ sit aspernatur aut odit ___ fugit. </p>
										</div>
							...
							<li id="collapsefour" class="collapse sj-active sj-userinfohold" aria-labelledby="headingfour" data-parent="#accordion">
								...
								<div id="subaccordiond" class="sj-statusholder">
									<div id="subheadingOned" class="sj-statusheaderholder sj-statuspadding" data-toggle="collapse" data-target="#subcollapseOned" aria-expanded="true" aria-controls="subcollapseOned" role="button">
										<figure class="sj-statusimg">
											<img src="/public/images/thumbnails/img-03.jpg" alt="img description">
										</figure>
										<div class="sj-statusheader">
									...
									<div id="subcollapseOned" class="sj-statusdescription collapse sj-active" aria-labelledby="subheadingOned" data-parent="#subaccordiond">
										<div class="sj-description">
											<p>Excepteur sint occaecat cupidatat ___ proident, sunt in culpa ___ officia deserunt mollit laudantium, ____  sunt voluptatem quia ________ sit aspernatur aut odit ___ fugit. </p>
										</div>
										<ul class="sj-statusdescriptionpoints">
									...
									<div id="subheadingtwod" class="sj-statusheaderholder sj-statuspadding" data-toggle="collapse" data-target="#subcollapsetwod" aria-expanded="true" aria-controls="subcollapsetwod" role="button">
										<figure class="sj-statusimg">
											<img src="/public/images/thumbnails/img-03.jpg" alt="img description">
										</figure>
										<div class="sj-statusheader">
									...
									<div id="subcollapsetwod" class="sj-statusdescription collapse sj-active" aria-labelledby="subheadingtwod" data-parent="#subaccordiond">
										<div class="sj-description">
											<p>Excepteur sint occaecat cupidatat ___ proident, sunt in culpa ___ officia deserunt mollit laudantium, ____  sunt voluptatem quia ________ sit aspernatur aut odit ___ fugit. </p>
										</div>
										<ul class="sj-statusdescriptionpoints">
									...
									<div id="subheadingthreed" class="sj-statusheaderholder sj-statuspadding" data-toggle="collapse" data-target="#subcollapsethreed" aria-expanded="true" aria-controls="subcollapsethreed" role="button">
										<figure class="sj-statusimg">
											<img src="/public/images/thumbnails/img-03.jpg" alt="img description">
										</figure>
										<div class="sj-statusheader">
									...
									<div id="subcollapsethreed" class="sj-statusdescription collapse sj-active" aria-labelledby="subheadingthreed" data-parent="#subaccordiond">
										<div class="sj-description">
											<p>Excepteur sint occaecat cupidatat ___ proident, sunt in culpa ___ officia deserunt mollit laudantium, ____  sunt voluptatem quia ________ sit aspernatur aut odit ___ fugit. </p>
										</div>
										<ul class="sj-statusdescriptionpoints">
...
</main><?php /**PATH D:\Disk_C\OSPanel\domains\OpenServer\domains\practice\resources\views/article_list/main.blade.php ENDPATH**/ ?>