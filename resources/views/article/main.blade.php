				...
				<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
					<div id="sj-content" class="sj-content">
						...
						<div class="sj-articles">
							<form action="{{route('search')}}" method="get" class="my-2">						
											<select name="year">
												<option>2016</option> 
												<option>2017</option>
												<option>2018</option>
							...
							<article class="sj-post sj-editorchoice">
								<figure class="sj-postimg">
									<img src="/public/images/{{$post->image}}" alt="image description">
								</figure>
								<div class="sj-postcontent">
									<div class="sj-head">
										<span class="sj-username">{{$post->fio}}</span>
										<h3>{{$post->title}}</h3>
									</div>
									<div class="sj-description">
										<p>{{$post->description}}</p>
									</div>
									<a class="sj-btn" href="{{route('desc',$post->id)}}">Описания </a>
								</div>
							</article>
							@endforeach
						</div>
